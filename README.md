...
## You have to change below thing

There are three Environment available. Choices are:
  1. PayPalEnvironmentNoNetwork == for now verification just demo
  2. PayPalEnvironmentSandbox   == for sendbox verification
  3. PayPalEnvironmentProduction == this is for live

You have to Change Both Client Id with your id if you dont have Product Client ID then use "YOUR_PRODUCTION_CLIENT_ID" do not comment it
